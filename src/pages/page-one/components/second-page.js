...
function SecondPage() {
  return (
    <React.Fragment>
      <Stack direction="row" alignItems="center" justifyContent="space-between" spacing={'2rem'} sx={{ border: '1px solid red', height: '100vh'}}>
        <Box component="img"
            sx={{
                height: '96%',
            ...
            />
            <Stack sx={{ border: '1px solid green'}} spacing={'2rem'}>
            ...
            <Box sx={{ width: '5%', border: 1, height: '100%'}}></Box>
      </Stack>
    </React.Fragment>
  );
}
